...
public class IniciarView extends VerticalLayout {
    ...
    public IniciarView() {
        ...
        iniSes.getStyle().set("background-color", "#1B195B");
        ...
        regisInic.getStyle().set("background-color", "#1B195B");
    ...
    private void iniciarSesion() {
        ...
        if (valCreden(nombreUsuario, contra)) {
            ...
            Notification.show("Inicio de sesión exitoso").setPosition(Notification.Position.MIDDLE);
            getUI().ifPresent(ui -> ui.navigate("info"));
        } else {
            Notification.show("Datos Incorrecto, intente de nuevo").setPosition(Notification.Position.MIDDLE);
        }
    }
